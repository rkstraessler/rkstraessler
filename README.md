<div align="center">
  <h1>👋 Hey, I'm Kevin</h1>
  <h3>Software Developer at REIKEM · TypeScript &amp; Rust Engineer</h3>
  <p>Building reliable products, developer tools and clean automation for real-world workflows.</p>
...
<p>
  <img src="https://skillicons.dev/icons?i=ts,rust" alt="TypeScript and Rust">
</p>
...
<p>
  <img src="https://skillicons.dev/icons?i=postgres,redis,docker,linux,git,github,githubactions" alt="PostgreSQL, Redis, Docker, Linux, Git, GitHub and GitHub Actions">
</p>

## 🔨 Current Focus

- 🦀 Growing deeper in Rust for reliable services and developer tools.
- ⚛️ Building maintainable full-stack applications with TypeScript and TanStack.
- 📦 Creating reusable packages, components and integrations for everyday workflows.
- ⚙️ Automating builds, releases and dependency updates with reproducible CI/CD.
